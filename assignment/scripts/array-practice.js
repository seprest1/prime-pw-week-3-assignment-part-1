...
let favoriteFoods = ['watermelon', 'cherries', 'pineapple'];
...
favoriteFoods.unshift('passionfruit');
console.log('Added a new food item to the beginning,', favoriteFoods);
...
let weirdArray = favoriteFoods.concat(animalArray);
